...
public class FeedSupplementaryHeaderView: UICollectionReusableView {
  ...
  internal struct FeedSupplementaryHeaderViewRepresentable: UIViewRepresentable {
    ...
    func makeUIView(context: UIViewRepresentableContext<FeedSupplementaryHeaderViewRepresentable>)
      -> FeedSupplementaryHeaderView
    {
      return FeedSupplementaryHeaderView()
    }

    func updateUIView(
      _ uiView: FeedSupplementaryHeaderView,
      context: UIViewRepresentableContext<FeedSupplementaryHeaderViewRepresentable>
    ) {
  ...
  internal struct FeedSupplementaryHeaderView_Preview: PreviewProvider {
    ...
    static var previews: some View {
      ForEach(ColorScheme.allCases, id: \.self) { colorScheme in
        FeedSupplementaryHeaderViewRepresentable(
