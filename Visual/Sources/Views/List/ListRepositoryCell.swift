...
internal class ListRepositoryCell: BaseUICollectionViewCell {
  ...
  private func addStackView() {
    ...
    NSLayoutConstraint.activate([
      ...
      stackView.leadingAnchor.constraint(
        equalTo: imageView.trailingAnchor, constant: stackViewPadding),
  ...
  private func addAdditionalInfoLabel() {
    ...
    NSLayoutConstraint.activate([
      ...
      additionalInfoLabel.leadingAnchor.constraint(
        equalTo: imageView.trailingAnchor, constant: stackViewPadding),
  ...
  private func addSupplementaryInfoLabel() {
    ...
    NSLayoutConstraint.activate([
      ...
      supplementaryInfoLabel.leadingAnchor.constraint(
        equalTo: additionalInfoLabel.trailingAnchor, constant: additionalInfoPadding),
    ])
  }
  ...
  struct ListRepositoryCellRepresentable: UIViewRepresentable {
    ...
    func makeUIView(context: UIViewRepresentableContext<ListRepositoryCellRepresentable>)
      -> ListRepositoryCell
    {
    ...
    func updateUIView(
      _ uiView: ListRepositoryCell,
      context: UIViewRepresentableContext<ListRepositoryCellRepresentable>
    ) {
  ...
  struct ListRepositoryCell_Preview: PreviewProvider {
    ...
    static var previews: some View {
      ForEach(ColorScheme.allCases, id: \.self) { colorScheme in
        ListRepositoryCellRepresentable(
          titleLabel: .constant("Name label"),
