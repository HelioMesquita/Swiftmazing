...
internal class FeedRepositoryCell: BaseUICollectionViewCell {
  ...
  private func addMainStackView() {
    ...
    NSLayoutConstraint.activate([
      ...
      mainStackView.trailingAnchor.constraint(
        equalTo: additionalStackView.leadingAnchor, constant: -stackViewPadding),
    ])
  }
  ...
  public func configure<T: FeedCollectionViewModelProtocol>(
    _ element: T, index: Int, numberOfElements: Int
  ) {
  ...
  struct FeedRepositoryCellRepresentable: UIViewRepresentable {
    ...
    func makeUIView(context: UIViewRepresentableContext<FeedRepositoryCellRepresentable>)
      -> FeedRepositoryCell
    {
    ...
    func updateUIView(
      _ uiView: FeedRepositoryCell,
      context: UIViewRepresentableContext<FeedRepositoryCellRepresentable>
    ) {
  ...
  struct FeedRepositoryCell_Preview: PreviewProvider {
    ...
    static var previews: some View {
      ForEach(ColorScheme.allCases, id: \.self) { colorScheme in
        FeedRepositoryCellRepresentable(
