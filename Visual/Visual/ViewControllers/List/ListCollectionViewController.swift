...
open class ListCollectionViewController<T: ListCollectionViewModelProtocol>: BaseViewController {
    ...
    lazy public var dataSource: UICollectionViewDiffableDataSource<ListSection, T> = {
        ...
        var dataSource = UICollectionViewDiffableDataSource<ListSection, T>(collectionView: self.collectionView) { [weak self]  (collectionView, indexPath, element) -> UICollectionViewCell? in
    ...
    private func createLayout() -> UICollectionViewCompositionalLayout {
        ...
        let groupSize = NSCollectionLayoutSize(widthDimension: .completedWidth, heightDimension: repositoriesItemHeight)
